...
interface EventMessagePreviewProps<T extends Model>{
    previewModel?: T;
...
function EventMessagePreview(props: EventMessagePreviewProps<EventMessage>) {
                        ...
                        <div className="preview__header">
                            ...
                            <div className="preview__header-info">
                                <div className="preview__header-text">
                                    ...
                                    <span className="preview__header-date">{translate('eventMessages.startDate')} { previewModel.startDate ? moment(previewModel.startDate).format('DD/MM/YYYY') : null }</span>
                                </div>
                        ...
                        <div className="preview__body">
                            <div className="preview__content">
                                <Descriptions title={previewModel.name} column={2}>
                                    ...
                                    <Descriptions.Item label={translate('eventMessages.time')}>
                                        <span className="gradient-text">
                                            { previewModel.time ? moment(previewModel.time).format('DD/MM/YYYY') : null }
                                        </span>
                                    </Descriptions.Item>
                                    
                                    
                                    
                                    <Descriptions.Item label={translate('eventMessages.entityName')}>
                                        <span className="gradient-text">{ previewModel.entityName }</span>
                                    </Descriptions.Item>
                                    
                                    
                                    <Descriptions.Item label={translate('eventMessages.content')}>
                                        <span className="gradient-text">{ previewModel.content }</span>
                                    </Descriptions.Item>
...
export default EventMessagePreview;
