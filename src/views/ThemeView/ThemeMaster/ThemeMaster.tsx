...
import { THEME_DETAIL_ROUTE } from "config/route-consts";
...
function ThemeMaster() {
    ...
    } = masterService.useMaster<Theme, ThemeFilter>
    (
        ThemeFilter,
        THEME_DETAIL_ROUTE,
            ...
            () => [
                    {
                        ...
                        key: "index",
                        width: 100,
                        render: renderMasterIndex<Theme>(pagination),
                    },
                    ...
                    {
                        title: (<div className='text-center'>{translate('themes.code')}</div>),
                    ...
                    {
                        title: (<div className='text-center'>{translate('themes.name')}</div>),
    ...
    return (
        <>
                                ...
                                <div className='d-flex justify-content-between'>
                                    ...
                                    <div className='flex-shrink-1 d-flex align-items-center'>
                                        ...
                                        <Tooltip title={translate("general.button.downloadTemplate")}>
                                            <button className='btn border-less gradient-btn-icon grow-animate-2'
                                                    onClick={handleExportTemplateList(themeRepository.exportTemplate)}>
            ...
            <ThemePreview previewModel={previewModel}
