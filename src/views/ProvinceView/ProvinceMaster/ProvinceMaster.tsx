...
import ProvincePreview from "./ProvincePreview";
/* end general import */
...
import { PROVINCE_DETAIL_ROUTE } from "config/route-consts";
...
function ProvinceMasterView() {
    ...
    } = masterService.useMaster<Province, ProvinceFilter>
    (
        ProvinceFilter,
    ...
    return (
        <>
                                ...
                                <div className='d-flex justify-content-between'>
                                    <div className='flex-shrink-1 d-flex align-items-center'>
                                        <div className='table-title ml-2'>
                                            {translate('provinces.table.title')}
                                        </div>
                                    </div>
                                    ...
                                    <div className='flex-shrink-1 d-flex align-items-center'>
                                        ...
                                        <Tooltip title={translate("general.button.exportExcel")}>
                                            <button className='btn border-less gradient-btn-icon grow-animate-2'
                                                    onClick={handleListExport(filter, provinceRepository.export)}>
                                                <i className='tio-file_outlined' />
                                            </button>
                                        </Tooltip>
                                        <Tooltip title={translate("general.button.downloadTemplate")}>
                                            <button className='btn border-less gradient-btn-icon grow-animate-2'
                                                    onClick={handleExportTemplateList(provinceRepository.exportTemplate)}>
            ...
            <ProvincePreview previewModel={previewModel}
