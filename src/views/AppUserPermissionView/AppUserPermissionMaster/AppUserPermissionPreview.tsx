...
interface AppUserPermissionPreviewProps<T extends Model>
    {
    previewModel?: T;
    ...
    function AppUserPermissionPreview(props: AppUserPermissionPreviewProps<AppUserPermission>
        ) {
        ...
        // const [userInfo] = useGlobal<AppUser>('user');
                        ...
                        <div className="preview__header">
                            ...
                            <div className="preview__header-info">
                                <div className="preview__header-text">
                                    ...
                                    <span className="preview__header-date">{translate('appUserPermissions.startDate')} { previewModel.startDate ? moment(previewModel.startDate).format('DD/MM/YYYY') : null }</span>
                                </div>
                        ...
                        <div className="preview__body">
                            <div className="preview__content">
                                <Descriptions title={previewModel.name} column={2}>
                                    ...
                                    <Descriptions.Item label={translate('appUserPermissions.path')}>
                                        <span className="gradient-text">{ previewModel.path }</span>
                                    </Descriptions.Item>
                                    
                                    
                                    <Descriptions.Item label={translate('appUserPermissions.count')}>
                                        <span className="gradient-text">{ previewModel.count }</span>
                                    </Descriptions.Item>
            ...
            export default AppUserPermissionPreview;
