...
export function useFieldTable (
    ...
    const [
        fieldFilter,
        dispatchFieldFilter,
    ] = React.useReducer<React.Reducer<FieldFilter,AdvanceFilterAction<FieldFilter>>>(advanceFilterReducer, new FieldFilter());
    ...
    const fieldContentColumns = React.useMemo(() => {
        return CreateTableColumns(
                ...
                .AddChild(
                    ...
                    .Key("index")
                    .Width(120)
                    .Render(masterTableIndex<Field,FieldFilter>
                        (fieldFilter),
                    ),
                ),
                ...
                CreateColumn()
                    ...
                    CreateColumn()
                      .Key("actions") // key
                      .Width(120)
                      .DataIndex(nameof(fieldContents[0].key))
                      .Render(
                        RenderActionColumn(
                          CreateTableAction()
