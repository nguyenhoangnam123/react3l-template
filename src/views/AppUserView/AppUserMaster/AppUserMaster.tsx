...
import AppUserDetailModal from "../AppUserDetail/AppUserDetailModal"; // import for detail modal
/* end general import */
...
function AppUserMaster() {
  ...
  const {
    ...
    handleSearch, // optional for detailService.useDetailModal
  ...
  const columns: ColumnProps<AppUser>[] = useMemo(
    () => [
      ...
      {
        title: (
          <div className='text-center'>{translate("appUsers.username")}</div>
        ),
      ...
      {
        title: (
          <div className='text-center'>{translate("appUsers.password")}</div>
        ),
      ...
      {
        title: (
          <div className='text-center'>{translate("appUsers.otpCode")}</div>
        ),
      ...
      {
        title: (
          <div className='text-center'>{translate("appUsers.otpExpired")}</div>
        ),
      ...
      {
        title: (
          <div className='text-center'>{translate("appUsers.displayName")}</div>
        ),
      ...
      {
        title: (
          <div className='text-center'>{translate("appUsers.address")}</div>
        ),
      ...
      {
        title: (
          <div className='text-center'>{translate("appUsers.department")}</div>
        ),
      ...
      {
        title: (
          <div className='text-center'>{translate("appUsers.avatar")}</div>
        ),
      ...
      {
        title: (
          <div className='text-center'>{translate("appUsers.birthday")}</div>
        ),
      ...
      {
        title: (
          <div className='text-center'>{translate("appUsers.longitude")}</div>
        ),
      ...
      {
        title: (
          <div className='text-center'>{translate("appUsers.latitude")}</div>
        ),
  ...
  return (
    <>
            ...
            >
              <Row className='mt-4'>
                ...
                <Col lg={4} className='pr-4'>
                  ...
                  <AdvanceStringFilter
                    value={filter[nameof(list[0].password)]["contain"]}
                    onChange={handleChangeFilter(
                      nameof(list[0].password),
                      "contain" as any,
                      StringFilter,
                ...
                <Col lg={4} className='pr-4'>
                  <label className='label'>translate('appUsers.otpCode')</label>
                  <AdvanceStringFilter
                    value={filter[nameof(list[0].otpCode)]["contain"]}
                    onChange={handleChangeFilter(
                      nameof(list[0].otpCode),
                      "contain" as any,
                      StringFilter,
                ...
                <Col lg={4} className='pr-4'>
                  ...
                  <AdvanceDateFilter
                    value={filter[nameof(list[0].otpExpired)]["equal"]}
                    onChange={handleChangeFilter(
                      nameof(list[0].otpExpired),
                      "equal" as any,
                      DateFilter,
                ...
                <Col lg={4} className='pr-4'>
                  <label className='label'>translate('appUsers.address')</label>
                  <AdvanceStringFilter
                    value={filter[nameof(list[0].address)]["contain"]}
                    onChange={handleChangeFilter(
                      nameof(list[0].address),
                      "contain" as any,
                      StringFilter,
                ...
                <Col lg={4} className='pr-4'>
                  ...
                  <AdvanceStringFilter
                    value={filter[nameof(list[0].phone)]["contain"]}
                    onChange={handleChangeFilter(
                      nameof(list[0].phone),
                      "contain" as any,
                      StringFilter,
                ...
                <Col lg={4} className='pr-4'>
                  ...
                  <AdvanceStringFilter
                    value={filter[nameof(list[0].department)]["contain"]}
                    onChange={handleChangeFilter(
                      nameof(list[0].department),
                      "contain" as any,
                      StringFilter,
                ...
                <Col lg={4} className='pr-4'>
                  <label className='label'>translate('appUsers.avatar')</label>
                  <AdvanceStringFilter
                    value={filter[nameof(list[0].avatar)]["contain"]}
                    onChange={handleChangeFilter(
                      nameof(list[0].avatar),
                      "contain" as any,
                      StringFilter,
                ...
                <Col lg={4} className='pr-4'>
                  ...
                  <AdvanceDateFilter
                    value={filter[nameof(list[0].birthday)]["equal"]}
                    onChange={handleChangeFilter(
                      nameof(list[0].birthday),
                      "equal" as any,
                      DateFilter,
                ...
                <Col lg={4} className='pr-4'>
                  <label className='label'>translate('appUsers.used')</label>
                </Col>
                ...
                <Col lg={4} className='pr-4'>
                  ...
                  <AdvanceNumberFilter
                    value={filter[nameof(list[0].longitude)]["equal"]}
                    onChange={handleChangeFilter(
                      nameof(list[0].longitude),
                      "equal" as any,
                      NumberFilter,
                ...
                <Col lg={4} className='pr-4'>
                  ...
                  <AdvanceNumberFilter
                    value={filter[nameof(list[0].latitude)]["equal"]}
                    onChange={handleChangeFilter(
                      nameof(list[0].latitude),
                      "equal" as any,
                      NumberFilter,
                ...
                <Col lg={4} className='pr-4'>
                  ...
                  <AdvanceIdFilter
                    value={filter[nameof(list[0].positionId)]["equal"]}
                    onChange={handleChangeFilter(
                ...
                <Col lg={4} className='pr-4'>
                  <label className='label'>{translate("appUsers.sex")}</label>
                  <AdvanceIdFilter
                ...
                <>
                  <div className='d-flex justify-content-between'>
                    ...
                    <div className='flex-shrink-1 d-flex align-items-center'>
                      ...
                      <Tooltip
                        title={translate("general.button.downloadTemplate")}
                      >
                        <button
                          className='btn border-less gradient-btn-icon grow-animate-2'
      ...
      <AppUserDetailModal
        ...
        visibleFooter={true} // display save and cancel button
      />
    </>
  );
}
